...
private val idlBuiltinArray = listOf(
    "a_correlate", "abs", "acos", "adapt_hist_equal", "alog",
    "alog2", "alog10", "amoeba", "annotate", "app_user_dir",
    "app_user_dir_query", "arg_present", "array_equal", "array_indices",
    "arrow", "ascii_template", "asin", "assoc", "atan",
    "axis", "bandpass_filter", "bandreject_filter", "barplot",
    ...
    "conj", "constrained_min", "contour", "convert_coord",
    ...
    "qromo", "qsimp", "query_ascii", "query_bmp",
    ...
    "strarr", "strcmp", "strcompress", "streamline",
    "stregex", "stretch", "string", "strjoin", "strlen",
    "strlowcase", "strmatch", "strmessage", "strmid", "strpos",
    "strput", "strsplit", "strtrim", "struct_assign", "struct_hide",
    "strupcase", "surface", "surfr", "svdc",
...
private val idlBuiltins = Regex(
    "^((" + idlBuiltinArray.joinToString(")|(") + "))\\b",
    RegexOption.IGNORE_CASE
)

private val idlKeywordArray = listOf(
    "begin", "end", "endcase", "endfor", "endwhile", "endif",
    "endrep", "endforeach", "break", "case", "continue", "for",
    "foreach", "goto", "if", "then", "else", "repeat", "until",
    "switch", "while", "do", "pro", "function"
)

private val idlKeywordsRE = Regex(
    "^((" + idlKeywordArray.joinToString(")|(") + "))\\b",
    RegexOption.IGNORE_CASE
)

private val idlIdentifiers =
    Regex("^[_a-z\\u00a1-\\uffff][_a-z0-9\\u00a1-\\uffff]*", RegexOption.IGNORE_CASE)
private val idlSingleOperators = Regex("[+\\-*&=<>/@#~\$]")
private val idlBoolOperators = Regex("^(and|or|eq|lt|le|gt|ge|ne|not)\\b", RegexOption.IGNORE_CASE)

private fun idlTokenBase(stream: StringStream): String? {
    ...
    if (stream.match(idlKeywordsRE) != null) return "keyword"
    if (stream.match(idlBuiltins) != null) return "builtin"
    if (stream.match(idlIdentifiers) != null) return "variable"

    if (stream.match(idlSingleOperators) != null || stream.match(idlBoolOperators) != null) {
        return "operator"
    }
